...
Texture grassTexture9;
Texture roadTexture9;
Texture peakTexture9;
Texture bottomTexture9;
Texture cornerTexture33;
Texture cornerTexture34;
Texture cornerTexture35;
Texture cornerTexture36;
Texture rightTexture9;
Texture leftTexture9;
...
void CarSelectScreen::Load() {
	...
	std::cout << "Menu Load \n";
	{
		...
		if (!roadTexture9.loadFromFile("res/img/Straights/straight_noBorder.png", sf::IntRect(0, 0, 1000, 1000)))
		{
			std::cerr << "failed to load spritesheet!" << std::endl;
		}
		if (!peakTexture9.loadFromFile("res/img/Straights/straight_horizontal_noBorder_bottom.png", sf::IntRect(0, 0, 1000, 1000)))
		{
			std::cerr << "failed to load spritesheet!" << std::endl;
		}
		if (!bottomTexture9.loadFromFile("res/img/Straights/straight_horizontal_noBorder_top.png", sf::IntRect(0, 0, 1000, 1000)))
		{
			std::cerr << "failed to load spritesheet!" << std::endl;
		}
		if (!grassTexture9.loadFromFile("res/img/grass.png", sf::IntRect(0, 0, 1000, 1000)))
		{
			std::cerr << "failed to load spritesheet!" << std::endl;
		}
		if (!cornerTexture33.loadFromFile("res/img/Corners/90DegreeTopRight.png", sf::IntRect(0, 0, 1000, 1000)))
		{
			std::cerr << "failed to load spritesheet!" << std::endl;
		}
		if (!cornerTexture34.loadFromFile("res/img/Corners/90DegreeTopLeft.png", sf::IntRect(0, 0, 1000, 1000)))
		{
			std::cerr << "failed to load spritesheet!" << std::endl;
		}
		if (!cornerTexture35.loadFromFile("res/img/Corners/90DegreeBottomLeft.png", sf::IntRect(0, 0, 1000, 1000)))
		{
			std::cerr << "failed to load spritesheet!" << std::endl;
		}
		if (!cornerTexture36.loadFromFile("res/img/Corners/90DegreeBottomRight.png", sf::IntRect(0, 0, 1000, 1000)))
		{
			std::cerr << "failed to load spritesheet!" << std::endl;
		}
		if (!rightTexture9.loadFromFile("res/img/Straights/straight_vertical_noBorder_left.png", sf::IntRect(0, 0, 1000, 1000)))
		{
			std::cerr << "failed to load spritesheet!" << std::endl;
		}
		if (!leftTexture9.loadFromFile("res/img/Straights/straight_vertical_noBorder_right.png", sf::IntRect(0, 0, 1000, 1000)))
		{
			std::cerr << "failed to load spritesheet!" << std::endl;
		}
		...
		for each (auto t in grassTiles)
		{
			...
			t3->getSprite().setTexture(grassTexture9);
		...
		for each (auto t in peakTiles)
		{
			...
			t2->getSprite().setTexture(peakTexture9);
		...
		for each (auto t in bottomTiles)
		{
			...
			t2->getSprite().setTexture(bottomTexture9);
			t2->getSprite().setScale(0.400f, 0.400f);
		...
		for each (auto t in trackTiles)
		{
			...
			t2->getSprite().setTexture(roadTexture9);
			t2->getSprite().setScale(0.400f, 0.400f);
		...
		for each (auto t in corner2Tiles)
		{
			...
			t2->getSprite().setTexture(cornerTexture34);
			t2->getSprite().setScale(0.400f, 0.400f);
		...
		for each (auto t in corner3Tiles)
		{
			...
			t2->getSprite().setTexture(cornerTexture35);
			t2->getSprite().setScale(0.400f, 0.400f);
		...
		for each (auto t in corner4Tiles)
		{
			...
			t2->getSprite().setTexture(cornerTexture36);
			t2->getSprite().setScale(0.400f, 0.400f);
		...
		for each (auto t in rightTiles)
		{
			...
			t2->getSprite().setTexture(rightTexture9);
			t2->getSprite().setScale(0.400f, 0.400f);
		...
		for each (auto t in leftTiles)
		{
			...
			t2->getSprite().setTexture(leftTexture9);
			t2->getSprite().setScale(0.400f, 0.400f);
